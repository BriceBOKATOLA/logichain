...
router.post('/', authMiddleware.requireRole('admin', 'logistics_manager'), validate.validate(schemas.create), routeController.create); // Create
...
router.patch('/:id', authMiddleware.requireRole('admin', 'logistics_manager'), validate.validate(schemas.update), routeController.update); // Update (avant exécution)
